...
spending$Percentage <- spending$Value / sum(spending$Value) * 100

colors <- c("brown", "pink", "yellow", "violet")

pie(spending$Value,
    labels = paste(spending$Category, "(",spending$Percentage,"%)"),
    col = colors,
    main = "Monthly Income Spending of Dela Cruz Family")

legend("topright", spending$Category, fill = colors)
