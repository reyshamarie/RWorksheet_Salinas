...
6 A. Check for the structure of the dataset using the str() function. Describe what you
...
6 B. Create an R object that will contain the mean of the sepal.length,
...
6 C.Create a pie chart for the Species distribution. Add title, legends, and colors. Write
...
6 D. Subset the species into setosa, versicolor, and virginica. Write the R scripts
...
6 E. Create a scatterplot of the sepal.length and sepal.width using the different
...
This plot allows you to easily compare and differentiate between different species based on their sepal length and sepal width, offering a comprehensive and visually appealing representation of the data.
...
7 B. Get the total number of each variations and save it into another object. Save the
...
7 C. From the variations.RData, create a barplot(). Complete the details of the chart
...
# Add legend
legend("topright", legend = Vnames, fill = 1:16, title = "Variation Names", cex = 0.5)
